...
// //              await provider.updateCurrentLocation(false);
//             });
          }
          ...
          return GoogleMap(
            ...
            circles: radius == 0
                ? pickArea != null && pickArea!.radius > 0
                    ? Set<Circle>.from([pickArea])
                    : Set<Circle>()
                : {
                    Circle(
                      circleId: CircleId(radius.toInt().toString()),
                      strokeWidth: 5,
                      strokeColor: Theme.of(context).primaryColor,
                      fillColor: Theme.of(context).primaryColor.withOpacity(0.2),
                      center: initialTarget,
                      radius: (radius * 1.61) * 1000,
                    )
                  },
            onMapCreated: (GoogleMapController controller) {
              log("radius.toString() ${radius.toString()}");
