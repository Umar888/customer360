...
import 'package:gc_customer_app/screens/google_map/place_picker.dart';
      ...
      child: RoundedFrame(
        ...
        child: Row(
          children: <Widget>[
            ...
            Icon(Icons.search),
            SizedBox(width: 10),
            Expanded(child: _buildSearchTextFormField()),
            _buildTextClearIcon(),
          ],
        ),
      ),
  ...
  _displayOverlay(Widget overlayChild) {
    ...
    overlayEntry = OverlayEntry(
      builder: (context) => Positioned(
        top: widget.needBack?appBarRenderBox!.size.height:screenHeight*0.41,
