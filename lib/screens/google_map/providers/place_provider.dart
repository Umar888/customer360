...
import 'package:gc_customer_app/screens/google_map/models/pick_result.dart';
  ...
  Future<void> updateCurrentLocation(bool forceAndroidLocationManager) async {
    ...
    try {
      ...
      if (permissionGranted == LocationPlatformInterface.PermissionStatus.granted) {
        ...
        sharedPreference.setKey(key:"myLatitude",value:currentPosition!.latitude.toString());
        sharedPreference.setKey(key:"myLongitude",value:currentPosition!.longitude.toString());
      } else {
