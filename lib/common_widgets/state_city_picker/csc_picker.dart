...
typedef MyBuilderState = void Function(
    BuildContext context, void Function(String) selectState);
typedef MyBuilderCity = void Function(
    BuildContext context, void Function(String) selectCity);
...
class CSCPicker extends StatefulWidget {
  static final GlobalKey<CSCPickerState> globalKey = GlobalKey();
  ...
  final MyBuilderState builderState;
  final MyBuilderCity builderCity;
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Future<dynamic> getResponse() async {
    var res = await rootBundle.loadString(
        'packages/gc_customer_app/lib/common_widgets/state_city_picker/assets/country.json');
  ...
  Widget build(BuildContext context) {
    widget.builderState.call(context, onSelectedState);
    widget.builderCity.call(context, onSelectedCity);
...
//                           : Container(),
  ...
  Widget stateDropdown() {
    return DropdownWithSearch(
      ...
      textEditingController: widget.stateTextEditingController,
  ...
  Widget cityDropdown() {
    return DropdownWithSearch(
      ...
      textEditingController: widget.cityTextEditingController,
      ...
      onChanged: (value) {
        ...
        value != null ? onSelectedCity(value) : onSelectedCity(_selectedCity);
      },
    );
  }
}
